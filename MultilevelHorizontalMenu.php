...
class MultilevelHorizontalMenu extends Widget {
	...
	public function registerClientScripts() {
		...
		$this->getView()->registerJsFile($this -> _baseUrl[1] . '/menu.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
		$this->getView()->registerJsFile($this -> _baseUrl[1] . '/selectnav.min.js', ['depends' => [\yii\web\JqueryAsset::className()]]);

		$this->getView()->registerJs('
			selectnav(\'myslidemenu\',\'insertHere\');
		', View::POS_END, 'selectnavstart');
		$this->getView()->registerCssFile($this -> _baseUrl[1] . '/style.min.css', [], 'horizontal-menu-css');
	}
